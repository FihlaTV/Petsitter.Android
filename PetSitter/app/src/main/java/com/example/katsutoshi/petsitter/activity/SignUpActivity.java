...
public class SignUpActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void signUpUser(String email, String password) {
        ...
        View mView = LayoutInflater.from(SignUpActivity.this).inflate(R.layout.dialog_loading, null);
        ProgressBar mProgressBar = (ProgressBar) mView.findViewById(R.id.loading_user);
